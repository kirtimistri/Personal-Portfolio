...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-linear-to-br from-[#05011a] via-[#0a0520] to-[#05011a]" />
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute bottom-[15%] right-[5%] w-[35%] sm:w-[30%] md:w-[25%] lg:w-[20%] aspect-square rounded-full bg-blue-600/15 blur-[80px] sm:blur-[100px] md:blur-[120px] animate-float-slow"
          style={{ animationDelay: "-4s" }}
        />
        <div
          className="absolute top-[40%] left-[50%] -translate-x-1/2 w-[50%] sm:w-[45%] md:w-[40%] aspect-square rounded-full bg-indigo-600/10 blur-[100px] sm:blur-[120px] md:blur-[140px] animate-float-slow"
      ...
      >
        <div className="relative w-32 h-32">
          {/* Astronaut Body */}
          <div className="absolute inset-0">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-12 h-12 rounded-full bg-linear-to-b from-purple-200 to-blue-200 border-2 border-purple-500/60 shadow-lg shadow-purple-500/20">
              <div className="absolute inset-1 rounded-full bg-linear-to-br from-purple-400/40 to-blue-400/20" />
            ...
            <div className="absolute top-10 left-1/2 -translate-x-1/2 w-10 h-12 rounded-lg bg-linear-to-b from-purple-300 to-blue-400 border border-purple-500/40 shadow-lg shadow-purple-500/20">
            ...
            <div className="absolute top-12 left-1/2 -translate-x-[200%] w-3 h-8 rounded-full bg-linear-to-r from-purple-300 to-blue-400" />
            <div className="absolute top-12 right-1/2 translate-x-[200%] w-3 h-8 rounded-full bg-linear-to-l from-purple-300 to-blue-400" />

            <div className="absolute top-[88px] left-1/2 -translate-x-[150%] w-4 h-6 rounded-full bg-linear-to-b from-purple-400 to-blue-500" />
            <div className="absolute top-[88px] right-1/2 translate-x-[150%] w-4 h-6 rounded-full bg-linear-to-b from-purple-400 to-blue-500" />

            <div className="absolute top-10 -right-2 w-4 h-8 rounded-md bg-linear-to-b from-purple-500 to-blue-600" />

            <motion.div
              animate={{ rotate: [0, 10, -5, 0] }}
              transition={{ duration: 3, repeat: Infinity }}
              className="absolute -top-8 left-1/2 w-px h-12 bg-linear-to-b from-purple-500 to-blue-400"
      ...
      >
        <div className="relative">
          <div className="w-4 h-4 rounded-full bg-linear-to-br from-purple-400 to-blue-600 shadow-md shadow-purple-500/30">
            <div className="absolute inset-0 rounded-full bg-linear-to-tr from-purple-300 to-blue-400" />
          </div>
          <div className="absolute -left-8 top-1/2 -translate-y-1/2 w-20 h-0.5 bg-linear-to-l from-purple-500/60 via-blue-500/30 to-transparent" />
      ...
      >
        <div className="relative">
          <div className="w-2.5 h-2.5 rounded-full bg-linear-to-br from-purple-300 to-blue-500 shadow-sm" />
          <div className="absolute -left-6 top-1/2 -translate-y-1/2 w-14 h-0.5 bg-linear-to-l from-purple-500/50 to-transparent" />
        </div>
      </motion.div>
      ...
      {[...Array(3)].map((_, i) => (
        ...
        >
          <div className="relative w-3 h-3">
            <div className="absolute inset-0 rounded-full bg-linear-to-br from-gray-600 to-gray-800 shadow-sm" />
      ...
      {[...Array(2)].map((_, i) => (
        ...
        >
          <div className="relative">
            <div className="w-1 h-1 rounded-full bg-linear-to-r from-purple-400 to-blue-400 shadow-sm" />
            <div className="absolute -left-12 top-1/2 -translate-y-1/2 w-16 h-px bg-linear-to-l from-white/50 to-transparent" />
          </div>
        </motion.div>
      ))}
      ...
      >
        <div className="relative">
          <div className="w-8 h-6 rounded-lg bg-linear-to-r from-purple-600 to-blue-700 shadow-md" />
      ...
      >
        ...
        <div className="absolute bottom-[-45%] left-1/2 -translate-x-1/2 w-[105%] max-w-[1200px] aspect-square rounded-full bg-[radial-gradient(circle_at_30%_25%,#c084fc_0%,#a855f7_15%,#7c3aed_35%,#4c1d95_55%,#1e1b4b_100%)] shadow-[0_0_100px_-20px_rgba(139,92,246,0.3),0_0_140px_-40px_rgba(59,130,246,0.25)]">
          <div className="absolute inset-0 rounded-full overflow-hidden">
            <div className="absolute top-[18%] left-[10%] w-[45%] h-[35%] bg-linear-to-br from-purple-300/25 via-blue-300/15 to-transparent rounded-full blur-2xl" />
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto pt-[15vh]">
        ...
        >
          ...
          <span className="relative inline-block">
            <motion.span
              ...
              transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
              className="absolute inset-0 -z-10 blur-2xl bg-linear-to-r from-purple-600/40 via-fuchsia-600/40 to-blue-600/40 rounded-full"
            />
            <span className="relative font-extrabold italic text-transparent bg-clip-text bg-[linear-gradient(110deg,#c084fc_0%,#a855f7_20%,#7c3aed_40%,#6366f1_55%,#3b82f6_75%,#c084fc_100%)] bg-size-[250%_100%] animate-[shimmer_6s_linear_infinite] drop-shadow-[0_0_30px_rgba(139,92,246,0.3)]">
              Developer
            </span>
            <motion.span
              aria-hidden
              ...
              className="absolute -bottom-2 left-0 h-[2px] w-full origin-left rounded-full bg-linear-to-r from-purple-500 via-fuchsia-500 to-blue-500 shadow-[0_0_15px_rgba(139,92,246,0.4)]"
            />
          </span>
        </motion.h1>
        ...
        >
          Building beautiful, performant web applications that blend thoughtful design with robust engineering.
        </motion.p>
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="px-10 py-4 bg-linear-to-r from-purple-600 via-fuchsia-600 to-indigo-600 text-white rounded-full font-semibold transition-all shadow-[0_8px_30px_-8px_rgba(139,92,246,0.5)] hover:shadow-[0_12px_40px_-10px_rgba(139,92,246,0.6)]"
          >
            View Projects
          </motion.a>
          <motion.a
      ...
      <div className="pointer-events-none absolute bottom-0 left-0 right-0 h-[35%] z-[5] overflow-hidden">
        <motion.div
          ...
          className="absolute -bottom-24 -left-20 w-[70%] h-[60%] rounded-[50%] bg-linear-to-tr from-purple-600/30 via-fuchsia-600/20 to-transparent blur-2xl"
        />
        <motion.div
          animate={{ x: [0, -40, 0], opacity: [0.28, 0.42, 0.28] }}
          transition={{ duration: 22, repeat: Infinity, ease: "easeInOut" }}
          className="absolute -bottom-32 -right-24 w-[75%] h-[65%] rounded-[50%] bg-linear-to-tl from-indigo-600/30 via-purple-600/20 to-transparent blur-2xl"
        />
        <div className="absolute bottom-0 left-0 right-0 h-[35%] bg-linear-to-t from-purple-600/15 via-indigo-600/10 to-transparent blur-xl" />
      </div>

      <div className="absolute bottom-0 left-0 w-full h-20 bg-linear-to-t from-[#05011a] to-transparent z-10 pointer-events-none" />
        ...
        >
          ...
          <div className="w-5 h-8 border border-purple-400/30 rounded-full flex justify-center p-1">
            <motion.div
              ...
              className="w-1 h-2 bg-linear-to-b from-purple-500 to-blue-500 rounded-full"
            />
          </div>
        </motion.div>
      </motion.div>
